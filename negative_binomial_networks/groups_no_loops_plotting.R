...
theory_size_lower_3 <- read_theory("data/size_groups_no_loops_num_tri_3_lower_branch.txt", 3)
theory_size_lower_2 <- read_theory("data/size_groups_no_loops_num_tri_2_lower_branch.txt", 2)
theory_size_lower_1 <- read_theory("data/size_groups_no_loops_num_tri_1_lower_branch.txt", 1)

theory_size_upper_3 <- read_theory("data/size_groups_no_loops_num_tri_3_upper_branch.txt", 3)
theory_size_upper_2 <- read_theory("data/size_groups_no_loops_num_tri_2_upper_branch.txt", 2)
theory_size_upper_1 <- read_theory("data/size_groups_no_loops_num_tri_1_upper_branch.txt", 1)

theory_rho_boundary_3 <- read_theory("data/groups_no_loops_rho_boundary_num_tri_3.txt", 3)
theory_rho_boundary_2 <- read_theory("data/groups_no_loops_rho_boundary_num_tri_2.txt", 2)
theory_rho_boundary_1 <- read_theory("data/groups_no_loops_rho_boundary_num_tri_1.txt", 1)

theory_prob_3 <- read_theory("data/prob_groups_no_loops_num_tri_3.txt", 3)
theory_prob_2 <- read_theory("data/prob_groups_no_loops_num_tri_2.txt", 2)
theory_prob_1 <- read_theory("data/prob_groups_no_loops_num_tri_1.txt", 1)
