...
setwd("/Users/leah/Documents/loops_not_groups/negative_binomial_networks")

# Negative-binomial networks: curves are parametrised by num_tri (mean triangles
# per node), deg = 6, dispersion r = 3. Theory only -- no simulations to overlay.
...
theory_size_lower_3 <- read_theory("data/size_loops_and_groups_num_tri_3_lower_branch.txt", 3)
theory_size_lower_2 <- read_theory("data/size_loops_and_groups_num_tri_2_lower_branch.txt", 2)
theory_size_lower_1 <- read_theory("data/size_loops_and_groups_num_tri_1_lower_branch.txt", 1)

theory_size_upper_3 <- read_theory("data/size_loops_and_groups_num_tri_3_upper_branch.txt", 3)
theory_size_upper_2 <- read_theory("data/size_loops_and_groups_num_tri_2_upper_branch.txt", 2)
theory_size_upper_1 <- read_theory("data/size_loops_and_groups_num_tri_1_upper_branch.txt", 1)

theory_rho_boundary_3 <- read_theory("data/loops_and_groups_rho_boundary_num_tri_3.txt", 3)
theory_rho_boundary_2 <- read_theory("data/loops_and_groups_rho_boundary_num_tri_2.txt", 2)
theory_rho_boundary_1 <- read_theory("data/loops_and_groups_rho_boundary_num_tri_1.txt", 1)

theory_prob_3 <- read_theory("data/prob_loops_and_groups_num_tri_3.txt", 3)
theory_prob_2 <- read_theory("data/prob_loops_and_groups_num_tri_2.txt", 2)
theory_prob_1 <- read_theory("data/prob_loops_and_groups_num_tri_1.txt", 1)
...
size_plot <- ggplot() +
  ...
  labs(
    x = expression(T),
    y = expression("Size"),
    color = expression(symbol("\341") * k[t] * symbol("\361"))
  ) +
  theme_minimal() +
